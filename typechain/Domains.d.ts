...
export class Domains extends BaseContract {
  ...
  functions: {
    ...
    getAddress(name: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    getRecord(name: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    price(name: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    getAddress(name: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getRecord(name: string, overrides?: CallOverrides): Promise<BigNumber>;
